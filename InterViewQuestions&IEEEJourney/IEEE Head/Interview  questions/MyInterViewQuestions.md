...
1. okay lets dig deeper into the questions :D
   1. what is the difference between for loops and while loops?
      1. if he know, so please continue this empty places :
         ...
         4. int[] arr = [2,4,5,6]
         5. for(int x: ) // continue this loop 
            1. print(x) /// what is the output of this loop?
   2. what is the difference between using & and this && ? 
   3. do you know something about functions? 
      1. if yes tell me the output of this function
         1. printHello(string s){
            1. for(int)
         2. }
      2. what is the benfit of the functions? 
2.  can you write for me a function that can sort an array? 
3.  can you write me a function that can reverse a string? 
4.  what is the difference between parameters and arguments? parameters are the variables declared when we are defining the function, while the arguments are the parameters sent to the function when it is been called.  
...
11. what does blue print means? -> class
12. what is the inheritance ? 
13. what is capsulation? 
14. what is the polymorphism? 
15. what is the abstraction? 
